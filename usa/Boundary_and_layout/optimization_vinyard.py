...
print("Total AEP production of VineyardVineyard: %f MWh"%aep)


# Deliveriable 2
cost, state, recorder = problem.optimize()

recorder.save('optimization_vineyardwind')