...
def plot_farm_layout(farm):
    ...
    position_Lat_long = get_lat_long('/Users/yosephhassan/workspace 2/PROJECT-4-1/usa/revalution_layout.geojson')
...
def geoJson_coordinates_data(farm_name, continent):
    ...
    if continent == 'europe':
        europe = 'europe'
        filepath = os.path.join('/Users/yosephhassan/workspace 2/PROJECT-4-1/usa/revalution_layout.geojson')
    
    elif continent == 'usa':
        usa = 'usa'
        filepath = os.path.join('/Users/yosephhassan/workspace 2/PROJECT-4-1/usa/revalution_layout.geojson')

    filepath1 = os.path.join('/Users/yosephhassan/workspace 2/PROJECT-4-1/usa/revalution_layout.geojson')
...
### USA
    'Revolution wind':                            'revalution_layout.geojson',             
    #'vineyardwind1':                               'vineyard_layout.geojson', 
    #'coatsal virginia':                            'coastal_layout.geojson', 
    # Karehamn wind:                               'Karehamn_layout.geojson', 
