...
def plot_farm_layout(farm):
    ...
    position_Lat_long = get_lat_long('/Users/yosephhassan/workspace 2/PROJECT-4-1/usa/coastal_layout.geojson')
...
def geoJson_coordinates_data(farm_name, continent):
    ...
    if continent == 'europe':
        europe = 'europe'
        filepath = os.path.join('/Users/yosephhassan/workspace 2/PROJECT-4-1/usa/coastal_layout.geojson')
    
    elif continent == 'usa':
        usa = 'usa'
        filepath = os.path.join('/Users/yosephhassan/workspace 2/PROJECT-4-1/usa/coastal_layout.geojson')

    filepath1 = os.path.join('/Users/yosephhassan/workspace 2/PROJECT-4-1/usa/coastal_layout.geojson')
